...
<p align="center">
  <img src="https://img.shields.io/badge/version-4.3.17-blue" alt="version">
  ...
  <img src="https://img.shields.io/badge/tests-566%2F566-success" alt="tests">
</p>
...
```text
package version: 4.3.17
npm run check: passed
npm test: 566 tests, 561 passed, 5 skipped
...
| [docs/ACCEPTANCE-v4.3.17.md](docs/ACCEPTANCE-v4.3.17.md) | 当前版本验收记录。 |
