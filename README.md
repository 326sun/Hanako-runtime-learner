...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-938%2F938-success" alt="tests">
</p>
...
```powershell
git clone --branch v5.1.4 https://github.com/326sun/Hanako-runtime-learner.git
cd Hanako-runtime-learner
npm install
npm run build
npm run install-plugin
...
npm test: 938 tests, 933 passed, 5 skipped
