...
function makeProject({ version = "5.0.0", lockVersion = version, scenarios = 16, omitAcceptance = false, testCount = 851, zipEntries = ["index.js", "manifest.json", ...REQUIRED_TOOL_FILES] } = {}) {
