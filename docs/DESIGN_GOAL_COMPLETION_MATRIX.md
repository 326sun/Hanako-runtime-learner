...
当前版本：`5.1.4`（在 v5.0 冻结表面上追加默认关闭/只读的实验能力，外加 model advisor 可观测性补强、v5.1.1 全面审计加固、v5.1.3 的 profile 安全闸门修复与设置面板即时生效，以及 v5.1.4 的性能/复杂度治理收口）
