...
export async function scheduleTask(ctx, { pluginId = DEFAULT_PLUGIN_ID, type, scheduleId, intervalMinutes, payload = {} } = {}) {
  ...
  const schedules = listed.result?.schedules || listed.result?.items || [];
