...
import { enqueueReviewForProposal, markReviewForProposal } from "./review-queue.js";
import { validateProposal as validateWithGate } from "./validation-gate.js";
import { appendEvent } from "./event-log.js";
import { updateSkillState } from "./skill-registry.js";
...
export function applyProposal(learnerDir, id, { configPath = null } = {}) {
  ...
  const gate = validateWithGate(proposal);
